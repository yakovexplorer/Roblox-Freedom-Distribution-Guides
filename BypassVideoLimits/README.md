Videos are limited to a resolution of 1280x720 by default. I simply `nop`'d the comparisions and jumps immediately before `20001F0:"Video is using a resolution that is not supported."`.
